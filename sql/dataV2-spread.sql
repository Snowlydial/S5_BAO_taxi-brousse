...
('2025-12-19', 23), -- Cancelled 1 day before Dec 20 holiday trip
-- January cancellations
('2026-01-01', 28), -- New Year's Day cancellation
-- March cancellations
('2026-02-28', 37), -- Cancelled 1 day before Mar 1 trip
-- June cancellations
('2026-06-24', 54); -- Cancelled 1 day before Jun 25 peak trip
...
('2025-10-03 14:00:00', 12000.00, 1, 6),   -- Oct 5 trip (Economique)
('2025-10-03 14:30:00', 12000.00, 2, 7),   -- Oct 5 trip
('2025-10-06 15:00:00', 35000.00, 5, 8),   -- Oct 8 trip (Toamasina)
('2025-10-10 10:00:00', 18000.00, 4, 9),   -- Oct 12 trip (Antsirabe)
('2025-10-12 11:00:00', 65000.00, 2, 10),  -- Oct 15 trip (Fianarantsoa)
('2025-10-15 15:00:00', 75000.00, 4, 11),  -- Oct 18 trip (Special price)
('2025-10-16 15:30:00', 80000.00, 4, 12),  -- Oct 20 trip (Peak surcharge)
('2025-10-20 16:00:00', 100000.00, 2, 13), -- Oct 25 trip (Premium)

-- NOVEMBER 2025 payments
('2025-10-30 10:00:00', 12000.00, 1, 14),  -- Nov 2 trip
('2025-10-30 11:00:00', 12000.00, 1, 15),  -- Nov 2 trip
('2025-11-02 15:00:00', 35000.00, 3, 16),  -- Nov 5 trip
('2025-11-07 14:00:00', 18000.00, 3, 17),  -- Nov 10 trip
('2025-11-11 15:00:00', 65000.00, 3, 18),  -- Nov 15 trip

-- DECEMBER 2025 payments (holiday season)
('2025-11-28 09:00:00', 12000.00, 1, 19),  -- Dec 1 trip
('2025-11-28 10:00:00', 12000.00, 1, 20),  -- Dec 1 trip
('2025-12-02 11:00:00', 35000.00, 2, 21),  -- Dec 5 trip
('2025-12-07 12:00:00', 18000.00, 2, 22),  -- Dec 10 trip
('2025-12-12 13:00:00', 65000.00, 4, 23),  -- Dec 15 trip
('2025-12-16 14:00:00', 75000.00, 4, 24),  -- Dec 20 trip (holiday premium)
('2025-12-18 15:00:00', 85000.00, 5, 25),  -- Dec 22 trip (peak holiday)
('2025-12-24 16:00:00', 110000.00, 5, 26), -- Dec 28 trip (premium holiday)

-- JANUARY 2026 payments (New Year)
('2025-12-30 08:00:00', 12000.00, 1, 27),  -- Jan 2 trip
('2025-12-30 09:00:00', 12000.00, 1, 28),  -- Jan 2 trip
...
('2026-01-12 15:00:00', 100000.00, 4, 34), -- Jan 15 trip

-- FEBRUARY 2026 payments
('2026-01-28 09:00:00', 12000.00, 1, 35),  -- Feb 1 trip
('2026-01-28 10:00:00', 12000.00, 1, 36),  -- Feb 1 trip
('2026-02-02 11:00:00', 35000.00, 2, 37),  -- Feb 5 trip
('2026-02-07 12:00:00', 18000.00, 2, 38),  -- Feb 10 trip
('2026-02-11 13:00:00', 65000.00, 3, 39),  -- Feb 14 trip

-- MARCH 2026 payments
('2026-02-27 09:00:00', 12000.00, 1, 40),  -- Mar 1 trip (cancelled)
('2026-02-27 10:00:00', 12000.00, 1, 41),  -- Mar 1 trip
('2026-03-02 11:00:00', 35000.00, 2, 42),  -- Mar 5 trip
('2026-03-07 12:00:00', 18000.00, 2, 43),  -- Mar 10 trip
('2026-03-12 13:00:00', 65000.00, 3, 44),  -- Mar 15 trip

-- APRIL 2026 payments
('2026-03-28 09:00:00', 12000.00, 1, 45),  -- Apr 1 trip
('2026-03-28 10:00:00', 12000.00, 1, 46),  -- Apr 1 trip
('2026-04-02 11:00:00', 35000.00, 2, 47),  -- Apr 5 trip
('2026-04-07 12:00:00', 18000.00, 2, 48),  -- Apr 10 trip
('2026-04-12 13:00:00', 65000.00, 3, 49),  -- Apr 15 trip

-- MAY 2026 payments
('2026-04-27 09:00:00', 12000.00, 1, 50),  -- May 1 trip (Labor Day)
('2026-04-27 10:00:00', 12000.00, 1, 51),  -- May 1 trip
('2026-05-02 11:00:00', 35000.00, 2, 52),  -- May 5 trip
('2026-05-07 12:00:00', 18000.00, 2, 53),  -- May 10 trip
('2026-05-12 13:00:00', 65000.00, 3, 54),  -- May 15 trip

-- JUNE 2026 payments (end of school year)
('2026-05-28 09:00:00', 12000.00, 1, 55),  -- Jun 1 trip
('2026-05-28 10:00:00', 12000.00, 1, 56),  -- Jun 1 trip
('2026-06-02 11:00:00', 35000.00, 2, 57),  -- Jun 5 trip
('2026-06-07 12:00:00', 18000.00, 2, 58),  -- Jun 10 trip
('2026-06-12 13:00:00', 65000.00, 3, 59),  -- Jun 15 trip
('2026-06-16 14:00:00', 75000.00, 4, 60),  -- Jun 20 trip (special)
('2026-06-21 15:00:00', 80000.00, 5, 61),  -- Jun 25 trip (peak - cancelled)
('2026-06-25 16:00:00', 100000.00, 4, 62); -- Jun 28 trip (premium)
